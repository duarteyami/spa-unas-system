...
<jsp:useBean id="dataSource" class="prgs.fuentedato" scope="page"/>
<jsp:useBean id="fech" class="prgs.formatofecha" scope="page"/>
...
<%
    File reporte = new File(application.getRealPath("reportes/reporte_tip_serv.jasper"));
    if (!reporte.exists()) {
    ...
    try {
        ...
        resultado = st.executeQuery("SELECT * FROM tipo_servicio");                       
